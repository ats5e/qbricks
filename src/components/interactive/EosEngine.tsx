...
const differences = [
  { n: "01", title: "Forked, not wrapped", text: "A hardened fork of Apache DataFusion, a proven, vectorised query core, tuned for the single-node execution path managed Spark can’t take." },
  { n: "02", title: "Built with Rust", text: "Compiled, memory-safe and garbage-collection free, no JVM, no pauses. Predictable low-latency speed with a fraction of the memory footprint." },
  { n: "03", title: "Arrow-native streaming", text: "Data moves through the engine as Arrow, end to end, no serialisation between stages, no format tax, incremental change streamed as it lands." },
  { n: "04", title: "Large records at speed", text: "Ingests and joins hundreds of millions of records in seconds; built-in managed views keep downstream agents and dashboards hot." },
  { n: "05", title: "Capped compute cost", text: "The entire pipeline estate runs on one right-sized VM, a single committed line item. Compression shrinks the lakehouse footprint and storage bill too." },
  { n: "06", title: "Governed by design", text: "Every record checked against an Open Data Contract Standard contract, fully auditable, human in the loop." },
  { n: "07", title: "Python SDK", text: "Data science teams connect to QBricks in a few lines of Python and ingest foundational, governed data products in seconds, no pipeline build, no waiting on engineering." },
];
    ...
    <main className="min-h-screen bg-q-black">
      ...
      <section className="relative overflow-hidden border-b border-white/5 pb-24 pt-44">
        ...
        <div className="container-x relative z-10 text-center">
          ...
          >
            Our best-in-class SQL engine, among the fastest on the market, that powers <QBricksText />. Built with Apache DataFusion and Arrow-native streaming. Your entire pipeline estate on one right-sized machine.
          </motion.p>
        ...
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-q-gray-300">
              We will run your pipeline estate on one right-sized node and show you the compute line, before and after.
            </p>
