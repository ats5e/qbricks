      ...
      <section className="relative overflow-hidden border-b border-white/5 pt-44 pb-28">
        ...
        <div className="container-x relative z-10 text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-xl leading-relaxed text-q-gray-300 md:text-2xl">
            QBricks sits underneath the tools and programmes organisations already run: the governed metadata foundation that makes A.I., analytics and regulatory reporting trustworthy.
          </p>
