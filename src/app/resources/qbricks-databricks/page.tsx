...
export const metadata = {
  title: { absolute: "QBricks + Databricks | Capability Overview" },
...
const content: CapabilityContent = {
  ...
  gap: {
    ...
    text: "Databricks is built to host, analyse and serve coherent data at scale, and it does that exceptionally well. But it assumes the hard part is already done: that scattered, inconsistent, ungoverned sources have already become clean, trustworthy tables. In most organisations, they haven't. That gap is where medallion pipelines sprawl, DBUs burn on wrangling, and confidence in the numbers erodes. QBricks closes it.",
  },
