...
const content: CapabilityContent = {
  ...
  computeNote:
    "Because all the integration, cleaning and transformation run on local compute – at any size, with no Spark cluster – a single large-memory node handles wholesale-banking volumes. Your Databricks compute stays free for what it's for: analytics, ML and AI.",
