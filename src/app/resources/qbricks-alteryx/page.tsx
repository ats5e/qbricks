...
const content: CapabilityContent = {
  ...
  pillars: [
    ...
    },
    {
      ...
      text: "Every record is matched to the Open Data Contract Standard at ingestion. Nothing ungoverned reaches your workflows.",
    },
    {
      kicker: "// Open formats",
      title: "Yours to keep",
  ...
  fits: {
    ...
    intro:
      "QBricks doesn't replace any part of your platform. It sits upstream of it – a clean division of labor, with the governed data product passing cleanly between us.",
    qbricksHandles: [
