...
const content: CapabilityContent = {
  ...
  gap: {
    ...
    text: "Microsoft Fabric is built to unify storage, BI and AI on one SaaS foundation, and it does that exceptionally well. But it assumes the hard part is already done: that scattered, inconsistent, ungoverned sources have already become clean, trustworthy Delta tables. In most organisations, they haven't. That gap is where dataflows sprawl, capacity units burn on wrangling, and confidence in the numbers erodes. QBricks closes it.",
  },
