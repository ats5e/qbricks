...
const content: CapabilityContent = {
  ...
  gap: {
    ...
    text: "Cloudera is built to host, serve, and govern coherent data at scale, and it does that exceptionally well. But it assumes the hard part is already done: that scattered, inconsistent, ungoverned sources have already become clean, trustworthy tables. In most organisations, they haven't. That gap is where projects stall, costs climb, and confidence in the numbers erodes. QBricks closes it.",
  },
